...
Attribute Open_Single_File.VB_ProcData.VB_Invoke_Func = " \n14"
...
End Sub
Sub SheetAscending()
Attribute SheetAscending.VB_ProcData.VB_Invoke_Func = " \n14"
 n = WorksheetFunction.CountA(Range("A1:A30"))
 Range("C1").Select
    Selection.AutoFill Destination:=Range("C1:C" & n), Type:=xlFillDefault
   'Range("C1:C12").Select
For i = 1 To n
...
End Sub
Sub SheetAshiding()
Attribute SheetAshiding.VB_ProcData.VB_Invoke_Func = " \n14"
...
End Sub
Sub onehit()
Attribute onehit.VB_ProcData.VB_Invoke_Func = "q\n14"
